...
(如果上一場workshop已經安裝過Gemini，請確定目前Gemini-CLI的版本為v0.2.0，如果正確，可以跳過安裝Gemini-CLI以及Node.JS的步驟, 但仍需要設定API-KEY以及MCP Server的設定)
...
[source,shell]
----
npm install -g @google/gemini-cli@v0.2.0
gemini --version # Should be 0.2.0
----
